...
class BitMEXWebsocket():
    ...
    def connect(self, endpoint="", symbol="XBTUSD", shouldAuth=True):
        ...
        subscriptions = [sub + ':' + symbol for sub in ["trade","orderBookL2"]]
    ...
    def __get_auth(self):
        ...
        return [
            ...
            "api-signature: " + generate_signature("RuASRygI8FS65331UvAna2yjsMX0ObnmdOtjkn_GE8c7lnus", 'GET', '/realtime', nonce, ''),
            "api-key:" + "HDwD1WDPqSTQW9iNrt2OnUt7"
        ]
        ...
        try:
            if 'subscribe' in message:
                ...
                if action == 'partial':
                    ...
                    # logger.info("%s: partial %s" % message['data'])
                    ...
                    logger.info(message['data'])
                    # logger.info('%s: deleting %s' % (table, message['data']))
...
if __name__ == "__main__":
    ...
    # ch.setFormatter(formatter)
    # logger.addHandler(ch)
    logger = setup_logger('log1','trade_log.txt')
    logger2 = setup_logger('log2','orderbook_log.txt')
